...
public class AccountsPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTableAccounts.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User ID", "Employee ID", "Name", "Position", "Department", "Username", "Role", "Account Status"
            }
        ) {
        ...
        jTableAccounts.setFocusable(false);
        jTableAccounts.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jTableAccounts.setShowGrid(true);
        jTableAccounts.getTableHeader().setResizingAllowed(false);
        ...
        jComboBoxSearchByStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Active", "Deactivated" }));
