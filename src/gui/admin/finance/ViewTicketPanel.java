...
public class ViewTicketPanel extends javax.swing.JPanel {
    ...
    private AdminFinancePortal financePortal;
    private final RequestService requestService;

    public ViewTicketPanel(AdminFinancePortal financePortal) {
    ...
    private void resolveTicket() {
        try {
            ...
            financePortal.getTicketsPanel().loadTicketHistory();
            financePortal.getFinanceDashboardPanel().loadMetrics();
    ...
    private void jLabelBackMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelBackMouseClicked
        ...
        cardLayout.show(financePortal.getPanelParentCard(), "Tickets");
