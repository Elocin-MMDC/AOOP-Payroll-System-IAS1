...
public class AdminITPortal extends javax.swing.JFrame {
    ...
    public ITDashboardPanel getITDashboardPanel() {
        return itDashboardPanel;
    }
    ...
    public ViewAccountPanel getViewAccountPanel() {
        return viewAccountPanel;
    }
    ...
    private void addHooverEffectToTabs() {
        UIUtil.addHoverEffect(jLabelITDashboard, jPanelITDashboard, defaultPanelColor, hoverPanelColor);
        ...
        UIUtil.addHoverEffect(jLabelAccounts, jPanelAccounts, defaultPanelColor, hoverPanelColor);
        UIUtil.addHoverEffect(jLabelSecurity, jPanelSecurity, defaultPanelColor, hoverPanelColor);
    }
