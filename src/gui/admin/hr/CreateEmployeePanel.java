...
public class CreateEmployeePanel extends javax.swing.JPanel {
    ...
    public CreateEmployeePanel(AdminHRPortal hrPortal) {
    ...
    private void createEmployee() {
        ...
        if (lastName.isEmpty() || firstName.isEmpty() || genderName.equals("Select")
                || date == null || jTextFieldPhoneNumber.getText().trim().isEmpty()
                || jTextFieldStreet.getText().trim().isEmpty()
                ...
                || jTextFieldSssNumber.getText().trim().isEmpty()
                || jTextFieldPhilHealthNumber.getText().trim().isEmpty()
                || jTextFieldTin.getText().trim().isEmpty()
                || jTextFieldPagIbigNumber.getText().trim().isEmpty()
    ...
    private void clearAll() {
        ...
        jComboBoxWorkStatus.setSelectedIndex(0);
    ...
    private void initComponents() {
        ...
        jLabelCreateRecordSmall = new javax.swing.JLabel();
        ...
        jLabelCreateRecordSmall.setText("Employees > Create Record");
        jPanel1.add(jLabelCreateRecordSmall);
        jLabelCreateRecordSmall.setBounds(30, 60, 180, 16);
        ...
        jButtonClearAll.setBackground(new java.awt.Color(102, 102, 102));
        jButtonClearAll.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        jPanelCreateNewEmployeeBox.add(jButtonClearAll);
        jButtonClearAll.setBounds(680, 570, 170, 40);
        ...
        jButtonConfirm.setBackground(new java.awt.Color(0, 43, 89));
        ...
        jPanelCreateNewEmployeeBox.add(jButtonConfirm);
        jButtonConfirm.setBounds(870, 570, 170, 40);
    ...
    private javax.swing.JLabel jLabelCreateRecordSmall;
