...
public class ITDashboardPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabelPendingITTickets.setForeground(new java.awt.Color(0, 0, 0));
        jLabelPendingITTickets.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabelPendingITTickets.setText("Pending IT Tickets");
        jPanelPendingTickets.add(jLabelPendingITTickets);
        jLabelPendingITTickets.setBounds(20, 0, 240, 50);
