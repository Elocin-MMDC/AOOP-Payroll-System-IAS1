...
public class TicketsPanel extends javax.swing.JPanel {
    ...
    public TicketsPanel(AdminITPortal itPortal) {
    ...
    public final void loadTicketHistory() {
        List<SupportRequest> tickets = requestService.getSupportHistoryByTeam("IT");
    ...
    private void onViewClicked() {
        ...
        itPortal.getViewTicketPanel().loadSelectedTicket(ticketID);

        CardLayout cardLayout = (CardLayout) itPortal.getPanelParentCard().getLayout();
        cardLayout.show(itPortal.getPanelParentCard(), "ViewTicket");
    }
